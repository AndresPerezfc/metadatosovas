...
<div class="page-header">
                    <h1>
                        Busqueda
                        {{ Form::open(['route' => 'inicio', 'method' => 'GET', 'class'=> 'form-inline pull-right']) }}
...
<div class=container>
        numero de registros = ({{$ovasCount}})

    @foreach($ovas as $ova)
    <div class="list-group">
    <a href="{{ route('ova', $ova->slug) }}" class="list-group-item list-group-item-action flex-column align-items-start active">
